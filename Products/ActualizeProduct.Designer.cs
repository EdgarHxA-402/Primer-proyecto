...
{
    partial class ActualizeProduct
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            comboBox1.DataBindings.Add(new Binding("SelectedValue", productBindingSource1, "CategoryID", true));
            ...
            comboBox2.DataBindings.Add(new Binding("SelectedValue", productBindingSource2, "SupplierID", true));
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "ActualizeProduct";
            StartPosition = FormStartPosition.CenterParent;
            Text = "Actualize Product";
